...
public class MainPage extends AbstractPage{
    ...
    @FindBy(xpath = "//li//a[@href='/cabinet/auth/?login=yes&baskurl=%2F']//i")
    ...
    public MainPage pressLoginBtt(){
        this.loginBtt.click();
        new WebDriverWait(getDriver(), 10).until(ExpectedConditions.urlContains("/cabinet/auth/?login")); // /cabinet/auth/?login=yes&bask_url=%2F
        return this;
    }
